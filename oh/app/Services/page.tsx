...
const categories: Array<{ value: Service['category']; label: string; description: string; image?: string }> = [
  ...
  { value: 'children', label: 'Children & Family Services', description: 'Childhood vaccinations, head lice treatment, and newborn health support.' },
  ...
  { value: 'weight-loss', label: 'Weight Loss Services', description: 'Injectable weight loss programmes with expert support and regular check-ins.' },
