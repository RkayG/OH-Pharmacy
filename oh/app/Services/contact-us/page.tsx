...
export const metadata: Metadata = { title: 'Contact Us - OH Pharmacy', description: 'Get in touch with OH Pharmacy. We are here to help with all your healthcare needs.', 
